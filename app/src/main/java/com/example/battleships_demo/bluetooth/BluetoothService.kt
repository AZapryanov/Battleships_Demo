...
object BluetoothService {
    ...
    private var mListener: BtListener? = null
    ...
    */
     ...
     * succeeds or fails.
     */
    private class ConnectThread(private val mmDevice: BluetoothDevice, secure: Boolean) : Thread(){
